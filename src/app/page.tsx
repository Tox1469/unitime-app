  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#fafafa", fontFamily: "var(--font-dm-sans)" }}>
            ...
            <div className="w-full max-w-sm">
              <div className="p-6 rounded-2xl shadow-xl" style={{ background: "white" }}>
                <div className="text-center mb-5">
                  ...
                  <p className="text-[11px] mt-0.5" style={{ color: "#64748b" }}>Entre com seu RA e senha</p>
                </div>

                <div className="space-y-3">
                  <div>
                    <label className="text-[10px] font-semibold uppercase tracking-widest block mb-1" style={{ color: "#64748b" }}>RA do Aluno</label>
                  ...
                  <div>
                    <label className="text-[10px] font-semibold uppercase tracking-widest block mb-1" style={{ color: "#64748b" }}>Senha</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        style={{ background: "#f8fafc", border: "1px solid #e2e8f0", color: "#1e293b", "--tw-ring-color": "#00a89d" } as React.CSSProperties}
                      />
                      <button onClick={() => setShowSenha(!showSenha)} className="absolute right-3 top-1/2 -translate-y-1/2" style={{ color: "#64748b" }}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="text-[11px] font-medium hover:underline" style={{ color: "#64748b" }}>
                      Primeiro acesso
                    </button>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 mt-4 mb-3">
                  ...
                  <span className="text-[10px]" style={{ color: "#64748b" }}>ou entre como</span>
                  <div className="flex-1 h-px" style={{ background: "#e2e8f0" }} />
                </div>
      ...
      <footer className="py-4 text-center" style={{ borderTop: "1px solid #e8ecf0" }}>
        <p className="text-[11px]" style={{ color: "#64748b" }}>© 2026 UNICESUMAR. Todos os direitos reservados.</p>
